...
function ManageComplaintsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Manage Complaints</h1>

      <div className="mt-4">
        <ComplaintFilters onChange={setFilters} showDepartment showCategory />
      </div>
      ...
      <div className="mt-4">
        <ComplaintTable
          ...
          loading={loading}
          getDetailsPath={(complaint) => `/admin/complaints/${complaint._id}`}
